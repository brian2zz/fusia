...
class _AccountPageState extends State<AccountPage> {
  ...
  static String tagName(String inputString) {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _buildCard() =>
        Obx(() => BuildCardMember(name: namaUser.value, point: 100));
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundColor: Colors.transparent,
                        backgroundImage:
                            const AssetImage("assets/images/dummy_photo.png"),
                      ),
                    ),
                    Padding(
