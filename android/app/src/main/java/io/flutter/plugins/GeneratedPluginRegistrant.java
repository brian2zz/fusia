...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new dev.yanshouwang.camerax.CameraXPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin camerax, dev.yanshouwang.camerax.CameraXPlugin", e);
    }
    try {
